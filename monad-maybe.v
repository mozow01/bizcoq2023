...
Compute (find_key_return_value Cili data2).

Compute (find_key_return_list Cili data2 []).
...
Definition option_subtract_chain (a b c : nat) : option nat :=
  bind_opt nat nat (safe_minus a b) (fun output1 =>
    bind_opt nat nat (safe_minus output1 c) (fun output2 =>
      return_opt nat output2
    )
  ).

Compute (option_subtract_chain 3 2 1).
